...
export default function BileDuctExplorationPage() {
  const c = bileDuctExplorationContent;
    ...
    <Section ariaLabel={c.name}>
      <Breadcrumbs
        items={[
          ...
          { label: c.name, href: "/treatments/bile-duct-exploration" },
        ]}
      />
      ...
      <div className="flex max-w-3xl flex-col gap-10">
        ...
        <RiskInformation risks={c.risks} recovery={c.recovery} riskStatisticsNote={c.riskStatisticsNote} />
        ...
        <div className="rounded-(--radius-lg) border border-stone-200 bg-stone-100 p-6">
          <p className="mb-3 font-semibold text-ink-900">Concerned about a bile duct stone or blockage?</p>
