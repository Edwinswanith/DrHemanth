export function TreatmentSummary({
  ...
  return (
    <div className="flex flex-col gap-6">
      <p className="text-(length:--text-body-lg) text-ink-800">{summary}</p>

      <div>
        <h2 className="mb-2 text-(length:--text-heading)">Symptoms and reasons for referral</h2>
      ...
      <div>
        <h2 className="mb-2 text-(length:--text-heading)">How it&rsquo;s assessed</h2>
